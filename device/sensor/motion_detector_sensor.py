...
class MotionDetectorSensor(InterfaceSensor):
    """
    Motion detector sensor class representing a motion detector sensor device.
    """
    ...
    def __init__(
        ...
        self.coordinate_x2 = sensor_schema.coordinate_x2
        self.coordinate_y2 = sensor_schema.coordinate_y2
        self.created_at = sensor_schema.created_at
        self.updated_at = sensor_schema.updated_at
        self.armed = sensor_schema.armed
        self.detected = False

        assert self.sensor_type == SensorType.MOTION_DETECTOR_SENSOR, (
            "Sensor type must be MOTION_DETECTOR_SENSOR"
        )
